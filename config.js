...
global.personal_message = process.env.PERSONAL_MESSAGE || "My owner is currently offline, please kindly wait for him to come online";
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || "JEHUU-V2",
